#!/bin/bash
#SBATCH --job-name=gs_wtk_led_climate_qtls
#SBATCH --partition=short           
#SBATCH --nodes=1
#SBATCH --time=04:00:00
#SBATCH --output=logs/gs_wtk_led_climate_qtls_%j.out  
#SBATCH --error=logs/gs_wtk_led_climate_qtls_%j.out
#SBATCH --account=tap 
...
OUT_CSV="wtk_led_climate_quantiles_gold_standard_2007_2020.csv"
...
mkdir -p logs
LOG_FILE="logs/gs_wtk_led_climate_qtls_${SLURM_JOB_ID:-manual}.out"
